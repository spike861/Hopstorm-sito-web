            ...
            {!accessDenied ? (
              <>
                <div className="flex items-center justify-center mx-auto mb-8">
                  <img loading="lazy" decoding="async" src="https://res.cloudinary.com/dcbomk6i8/image/upload/v1775557006/foto/hopstorm_logo_bianco_trasparente_l3ftm9.png" alt="Hop Storm — birrificio artigianale a Roma" className="h-16 w-auto opacity-90" />
                </div>
              ...
              <>
                <div className="flex items-center justify-center mx-auto mb-8 grayscale opacity-50">
                  <img loading="lazy" decoding="async" src="https://res.cloudinary.com/dcbomk6i8/image/upload/v1775557006/foto/hopstorm_logo_bianco_trasparente_l3ftm9.png" alt="Hop Storm — birrificio artigianale a Roma" className="h-16 w-auto" />
                </div>
