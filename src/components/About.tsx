...
export default function About() {
  ...
  // Background darkens exactly as the text enters the screen
  const bgOpacity = useTransform(textScroll, [0, 1], [0, 0.95]);
    ...
    <section id="chi-siamo" ref={containerRef} className="relative bg-black">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-[150vh] pb-[20vh]">
        <div ref={textRef} className="text-center mb-16">
          ...
          <p className="text-2xl md:text-3xl text-[#D4A24E] font-medium">
            Nati da una tempesta, mossi dalla passione.
          </p>
        </div>
        
        <div className="space-y-12 text-white/90 text-xl md:text-2xl leading-relaxed text-left font-light">
          <p>
          ...
          <div className="pt-8">
            <h3 className="text-4xl font-bold text-white mb-6 text-center">Come lavoriamo</h3>
            <p className="font-medium text-[#D4A24E] text-center mb-6 text-2xl">Non filtriamo. Non pastorizziamo. Non prendiamo scorciatoie.</p>
            <p className="mb-6">
          ...
          <div className="pt-8">
            <h3 className="text-4xl font-bold text-white mb-6 text-center">Perché "Hop Storm"</h3>
            <p>
          ...
          <div className="pt-8">
            <h3 className="text-4xl font-bold text-white mb-6 text-center">Cosa ci guida</h3>
            <p className="mb-6">
